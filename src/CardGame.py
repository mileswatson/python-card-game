...
class SelectPlayers:
    ...
    def preload():
        ...
        app.addNamedButton("SELECT PLAYER 0", "SelectPlayers.Player0", SelectPlayers.login)
        ...
        app.addNamedButton("SELECT PLAYER 1", "SelectPlayers.Player1", SelectPlayers.login)
        ...
        app.addNamedButton("Play", "SelectPlayers.Play", SelectPlayers.play)
        app.addEmptyLabel("SelectPlayers.Empty2")
        app.addNamedButton("Change Password", "SelectPlayers.ChangePassword", SelectPlayers.changePassword)
        app.addNamedButton("Create Account", "SelectPlayers.CreateAccount", SelectPlayers.createAccount)
        app.addNamedButton("Delete Account", "SelectPlayers.DeleteAccount", SelectPlayers.deleteAccount)
        app.addNamedButton("Leader Board", "SelectPlayers.LeaderBoard", SelectPlayers.leaderBoard)
